package me.noteswiper.gyisti.client.model;
...
public class Modelbiped_fix<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("gyisti", "modelbiped_fix"), "main");
	...
	public Modelbiped_fix(ModelPart root) {
